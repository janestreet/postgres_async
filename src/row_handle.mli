...
val next
  :  local_ t
  -> f:local_ (local_ (read, no_seek, Iobuf.global) Iobuf.t option -> 'a)
  -> 'a option
...
val foldi
  ...
  -> f:
       local_ (column:Column_metadata.t
               -> value:local_ (read, no_seek, Iobuf.global) Iobuf.t option
               -> 'acc
               -> 'acc)
  -> 'acc
...
module Private : sig
  val create
    ...
    -> datarow:local_ ([> read ], seek, Iobuf.global) Iobuf.t
    -> local_ t
end
